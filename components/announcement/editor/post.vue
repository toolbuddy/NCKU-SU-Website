<template>
  <div>
    <section class="root">
      <small>Title</small>
      <h1 class="editor" id="title" contenteditable="true"> New Post Title </h1>
      <small>Editor</small>
      <section class="editor">
        <section class="toolbar float-left">
          ...
          <section class="fore-wrapper">
            <i class="fa fa-font" style="color: #C96;"></i>
            <section class="fore-palette">
        ...
        <section ref="content" id="content" contenteditable>
          <p>A Custom Editor.</p>
    ...
    <section class="button-area">
      <button class="submit-button" type="button" v-on:click="post"> 發布 Post </button>
      <button class="cancel-button" type="button"> 取消 Cancel </button>
    </section>
  </div>
</template>
