<template>
  <div>
    ...
    <div class="editor" contenteditable>
      <h1>A Proposal Editor.</h1>
      <p>Try making some changes here. Add your own text.</p>
    </div>
    
    <label> 提案者： {{author}} </label> <br/>
    <time> 提案時間：{{currentTime}} </time> <br/>
    <button type="button" v-on:click="proposal"> 提案 Proposal </button>
...
<script>
  export default {
    ...
    methods: {
      ...
      proposal: function () {
        console.log('proposal button click!!')
